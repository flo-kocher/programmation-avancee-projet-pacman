...
class IntersectionTemplate: public T
{
    ...
    public:
        IntersectionTemplate(int init_x, int init_y, bool init_has_pellet, bool init_path_right, bool init_path_down, bool init_path_left, bool init_path_up)
        : T(init_x, init_y, init_has_pellet)
